import type { MountResult, test } from "@playwright/experimental-ct-react";
...
> = {
  ...
  rows: readonly TRow[];
  /** Builds the component for one column/row combination. */
  component: (column: TColumn, row: TRow) => ReactElement;
  /**
