...
/**
 * A stand-in glyph for components that take an icon snippet. Inlined rather
 * than imported from `@okkly/icons` because a test file's non-component
 * imports are evaluated in Node, where the package's `?raw` SVG imports do not
 * resolve.
 *
